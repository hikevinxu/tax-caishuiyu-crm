        ...
        <el-card class="box-card">
          ...
          <div class="content">
            <div class="item month">
              <span>本月分发</span>
              <count-to :start-val="0" :end-val="1358" :duration="1000" class="card-panel-num"/>
            </div>
            <div class="item yesterday">
              <span>昨日分发</span>
              <count-to :start-val="0" :end-val="100" :duration="1000" class="card-panel-num"/>
            </div>
        ...
        <el-card class="box-card">
          ...
          <div class="content">
            <div class="item total">
              <span>人民币（¥）</span>
              <count-to :start-val="0" :end-val="2716" :duration="1000" class="card-panel-num"/>
            </div>
          </div>
        </el-card>
      </el-col>
