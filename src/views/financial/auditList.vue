<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="充值金额" align="center" width="120px">
        <template slot-scope="scope">
      ...
      <el-table-column label="操作" align="center" width="300px" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button style="margin-left: 12px;" type="warning" size="small" @click="handleRecharge(scope.row)">审批</el-button>
          <el-button style="margin-left: 12px;" type="success" size="small" @click="goAuditDetail(scope.row)">查看</el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="审核" :visible.sync="dialogFormVisible">
      <el-form :model="Recharge" style="display: flex;align-items: center;flex-flow: column;width: 100%;">
        <el-form-item  >
          <el-input type="textarea" v-model="Recharge.content" style="width: 600px" placeholder="请输入备注"></el-input>
        </el-form-item>
      </el-form>
